...
[Templates](http://bottlepy.org/docs/dev/tutorial.html#templates) werden im Ordner `views` abgelegt. Dort legen wir folgende einfache HTML-Datei `index.tpl` ab. Sie enthält den Platzhalter `{{mein_text}}`, der noch ersetzt werden muss.
